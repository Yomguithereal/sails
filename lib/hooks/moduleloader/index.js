  ...
  return {
    ...
    loadControllers: function(cb) {
      async.parallel({
        ...
        cb(err, sails.util.merge(controllers.main, controllers.plugins));
      });
    },
    ...
    loadPolicies: function(cb) {
      async.parallel({
        ...
        if (err)
          cb(err);
        cb(null, sails.util.merge(policies.main, policies.plugins));
      });
    },
    ...
    loadServices: function(cb) {
      async.parallel({
        ...
        if (err)
          ...
          cb(null, sails.util.merge(services.main, services.plugins));
      });
    },
    ...
    loadAdapters: function(cb) {
      async.parallel({
        ...
        if (err)
          ...
          cb(null, sails.util.merge(adapters.main, adapters.plugins));
      });
    },
    ...
    loadUserHooks: function(cb) {
      async.parallel({
        ...
        if (err)
          ...
          cb(null, sails.util.merge(hooks.main), hooks.plugins);
      });
    },
    ...
    loadBlueprints: function(cb) {
      async.parallel({
        ...
        if (err)
          ...
          cb(null, sails.util.merge(blueprints.main, blueprints.plugins));
      });
    },
    ...
    loadResponses: function(cb) {
      async.parallel({
        ...
        if (err)
          ...
          cb(null, sails.util.merge(responses.main, responses.plugins));
      });
    },
